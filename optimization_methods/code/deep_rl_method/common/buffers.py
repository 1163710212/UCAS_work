...
from deep_rl_method.common.preprocessing import get_action_dim, get_obs_shape
from deep_rl_method.common.type_aliases import (
...
class RolloutBuffer(BaseBuffer):
    ...
    and the logs probability of each taken action.
    ...
    def add(
        ...
        :param log_prob: logs probability of the action
            following the current policy.
        """
