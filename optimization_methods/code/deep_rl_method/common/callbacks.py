...
from deep_rl_method.common import base_class  # pytype: disable=pyi-error
from deep_rl_method.common.evaluation import evaluate_policy
from deep_rl_method.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization
...
class EvalCallback(EventCallback):
    ...
    def _log_success_callback(self, locals_: Dict[str, Any], globals_: Dict[str, Any]) -> None:
        ...
        in order to logs the success rate (when applicable),
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            # Dump logs so the evaluation results are printed with the correct timestep
