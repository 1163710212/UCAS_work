...
from deep_rl_method.common import utils
from deep_rl_method.common.callbacks import BaseCallback, CallbackList, ConvertCallback, ProgressBarCallback
from deep_rl_method.common.env_util import is_wrapped
from deep_rl_method.common.logger import Logger
from deep_rl_method.common.monitor import Monitor
from deep_rl_method.common.noise import ActionNoise
from deep_rl_method.common.policies import BasePolicy
from deep_rl_method.common.preprocessing import check_for_nested_spaces, is_image_space, is_image_space_channels_first
from deep_rl_method.common.save_util import load_from_zip_file, recursive_getattr, recursive_setattr, save_to_zip_file
from deep_rl_method.common.type_aliases import GymEnv, MaybeCallback, Schedule
from deep_rl_method.common.utils import (
...
from deep_rl_method.common.vec_env import (
    DummyVecEnv,
    VecEnv,
    VecNormalize,
    VecTransposeImage,
...
class BaseAlgorithm(ABC):
    ...
    :param tensorboard_log: the logs location for tensorboard (if None, no logging)
    ...
    def _setup_learn(
        ...
        :param tb_log_name: the name of the run for tensorboard logs
        :param progress_bar: Display a progress bar using tqdm and rich.
