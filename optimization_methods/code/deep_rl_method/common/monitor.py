...
from deep_rl_method.common.type_aliases import GymObs, GymStepReturn
...
class Monitor(gym.Wrapper):
    ...
    :param filename: the location to save a logs file, can be None for no logs
    :param allow_early_resets: allows the reset of the environment before it is done
    :param reset_keywords: extra keywords for the reset call,
        if extra parameters are needed at reset
    :param info_keywords: extra information to logs, from the information return of env.step()
...
class LoadMonitorResultsError(Exception):
    """
    Raised when loading the monitor logs fails.
    """
...
class ResultsWriter:
    ...
    :param filename: the location to save a logs file. When it does not end in
        the string ``"monitor.csv"``, this suffix will be appended to it
    :param header: the header dictionary object of the saved csv
    :param extra_keys: the extra information to logs, typically is composed of
...
def load_results(path: str) -> pandas.DataFrame:
    ...
    :param path: the directory path containing the logs file(s)
