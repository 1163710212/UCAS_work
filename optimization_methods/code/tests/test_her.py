...
from deep_rl_method import DDPG, DQN, SAC, TD3, HerReplayBuffer
from deep_rl_method.common.envs import BitFlippingEnv
from deep_rl_method.common.evaluation import evaluate_policy
from deep_rl_method.common.monitor import Monitor
from deep_rl_method.common.noise import NormalActionNoise
from deep_rl_method.common.vec_env import DummyVecEnv
from deep_rl_method.her.goal_selection_strategy import GoalSelectionStrategy
from deep_rl_method.her.her_replay_buffer import get_time_limit


def test_import_error():
    with pytest.raises(ImportError) as excinfo:
        from deep_rl_method import HER
