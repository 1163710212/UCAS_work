...
from deep_rl_method import A2C, PPO, SAC, TD3
from deep_rl_method.common.callbacks import BaseCallback
from deep_rl_method.common.logger import HParam
from deep_rl_method.common.utils import get_latest_run_id
...
def test_tensorboard(tmp_path, model_name):
    ...
    assert os.path.isdir(tmp_path / str(logname + "_1"))
    # Check that the logs dir name increments correctly
