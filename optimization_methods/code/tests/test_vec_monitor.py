...
from deep_rl_method.common.envs.bit_flipping_env import BitFlippingEnv
from deep_rl_method.common.evaluation import evaluate_policy
from deep_rl_method.common.monitor import Monitor, get_monitor_files, load_results
from deep_rl_method.common.vec_env import DummyVecEnv, VecMonitor, VecNormalize
...
def test_vec_monitor_load_results(tmp_path):
    """
    test load_results on logs files produced by the monitor wrapper
    """
