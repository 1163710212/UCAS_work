...
from deep_rl_method import A2C, PPO
...
from deep_rl_method.common.utils import set_random_seed
...
def test_entropy(dist):
    # The entropy can be approximated by averaging the negative logs likelihood
    # mean negative logs likelihood == differential entropy
    set_random_seed(1)
...
def test_categorical(dist, CAT_ACTIONS):
    # The entropy can be approximated by averaging the negative logs likelihood
    # mean negative logs likelihood == entropy
    set_random_seed(1)
